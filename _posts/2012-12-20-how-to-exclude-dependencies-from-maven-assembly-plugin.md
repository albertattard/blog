---
layout: post
title: How To Exclude Dependencies from Maven Assembly Plugin
description: Any dependencies that are already available at the runtime environment can be given the scope of provided and these will not be included by the maven-assembly-plugin plugin..
date: 2014-02-27 08:00:00 +0200
categories: maven
permalink: how-to-exclude-dependencies-from-maven-assembly-plugin
