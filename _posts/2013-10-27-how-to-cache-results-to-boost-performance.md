---
layout: post
title:  How to Cache Results to Boost performance
description: Computing the same results over and over again is a waste of time and resources.  Caching can help with that as the result is simply returned instead of recomputing it.  While in theory caching is very simple, in practice it can be quite challenging.
date: 2013-10-27 08:00:00 +0200
categories: cache, concurrency
img: how-to-cache-results-to-boost-performance/splash.png
permalink: how-to-cache-results-to-boost-performance
